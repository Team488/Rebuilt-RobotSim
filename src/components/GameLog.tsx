  ...
  return (
    <div className="game-log-panel">
      ...
      <div className="log-content">
        {results.length === 0 && (
          <div className="empty-log">No matches recorded yet.</div>
        )}
        {[...results].reverse().map((r, i) => (
          ...
          >
            <div className="log-item-header">Match #{results.length - i}</div>
            <div className="log-item-score">
              <span className="scores">
                <span className="red-score">{r.scoreRed}</span> -{" "}
                <span className="blue-score">{r.scoreBlue}</span>
              </span>
