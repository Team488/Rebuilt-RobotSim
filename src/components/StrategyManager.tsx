...
interface RobotConfigCardProps {
  robot: Robot;
  engine: Engine;
  editingRobotId: string | null;
  setEditingRobotId: (id: string | null) => void;
  tempName: string;
...
const RobotConfigCard: React.FC<RobotConfigCardProps> = ({
  robot,
  engine,
  editingRobotId,
  setEditingRobotId,
      ...
      <div className="robot-params">
        ...
        <div className="params-row">
          <div className="input-group">
            <label title={robot.scoringStrategy.description}>
              Active Strat ⓘ
            </label>
            <select
          ...
          <div className="input-group">
            <label title={robot.collectionStrategy.description}>
              Inactive Strat ⓘ
            </label>
            <select
...
export const StrategyManager: React.FC<StrategyManagerProps> = ({
  ...
  const handleExportTeams = async () => {
    ...
    savedTeams.forEach((team) => {
      zip.file(
        `${team.name.replace(/[^a-z0-9]/gi, "_").toLowerCase()}.json`,
  ...
  const handleImportZip = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      alert(
        "Failed to load zip file. Make sure it's a valid robot teams export.",
      );
    }
    ...
    <div className="strategy-manager-panel">
      ...
      <div className="teams-container">
        <div className="team-section">
          <h4 className="team-section-title red">
            🔴 Red Team: {engine.redTeamName}
          </h4>
            ...
            {engine.robots
              ...
              .map((robot) => (
                <RobotConfigCard
                  ...
                  setEditingRobotId={setEditingRobotId}
                  tempName={tempName}
        ...
        <div className="team-section">
          <h4 className="team-section-title blue">
            🔵 Blue Team: {engine.blueTeamName}
          </h4>
          <div className="robot-grid">
            {engine.robots
