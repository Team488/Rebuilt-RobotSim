                ...
                {engine.robots.map((r) => (
                    ...
                    >
                        ...
                        <div className="robot-status-banner">
                            <span className={`status-dot team-${r.team.toLowerCase()}`}></span>
                            <span className="status-text">{r.currentStrategy.status || "Analyzing field..."}</span>
                        </div>
                        <div className="robot-ball-stats">
                            Balls: <span className="ball-count">{r.ballCount} / {r.maxBalls}</span>
                        </div>
